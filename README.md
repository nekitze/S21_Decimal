...
This library should add the ability to work with the "decimal" type, which is not in the language standard.

## Build
1. Go to ```src/``` folder
2. Do ```make s21_decimal.a``` to build a static library 
